(() => {
  ...
  let n = null,
    ...
    d = null;
  const s = () => {
      d && (window.clearTimeout(d), d = null), n = null, r = null;
    },
    c = () => n;
  e.registerComponent({
    name: "tap-to-place",
  ...
  e.registerComponent({
    ...
    stateMachine: ({
      ...
      const f = () => {
        ...
        l(a).forEach(e => {
          const o = t.get(a, e),
            i = b.find(e => e.dataset.hotspot === o.label);
          if (i) try {
      ...
      d("initial").initial().onEnter(() => {
        ...
        const a = document.querySelector("#supra-ar-hud"),
          d = document.querySelector("#supra-scale-input"),
          c = document.querySelector(".supra-scale output"),
          l = document.querySelector(".supra-reset"),
          f = document.querySelector("#supra-car-hotspots"),
          u = e => e.stopPropagation();
        b = p.map(e => {
          const t = document.createElement("button");
          return t.className = "supra-car-hotspot", t.type = "button", t.dataset.hotspot = e.label, t.textContent = e.label, t.addEventListener("pointerdown", u), t.addEventListener("touchstart", u), t.addEventListener("click", () => window.location.assign(e.destination)), f.appendChild(t), t;
        }), a?.addEventListener("pointerdown", u), a?.addEventListener("touchstart", u), d.addEventListener("input", () => {
          const t = Number(d.value);
          c.value = `${t.toFixed(2)}x`, c.textContent = c.value, (t => {
            i = t, n && r && r.getEntity(n).set(e.Scale, {
              x: o * i,
              y: o * i,
              z: o * i
            });
        ...
        let m = null;
        const h = t => {
          if (2 !== t.touches.length || t.target instanceof Element && t.target.closest("#supra-ar-hud")) return void (m = null);
          const [a, o] = [t.touches[0], t.touches[1]],
            i = Math.atan2(o.clientY - a.clientY, o.clientX - a.clientX);
          var d;
          null !== m && (d = m - i, n && r && r.getEntity(n).rotateSelf(e.math.quat.yRadians(d))), m = i;
        };
      ...
      }).onTick(f).onEvent(e.events.REALITY_READY, "ready", {
